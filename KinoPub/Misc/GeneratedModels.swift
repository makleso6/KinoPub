...
public struct Bookmark: Codable {
    ...
    public struct Item: Codable {
        ...
        public init(id: Int, type: String, subtype: String, title: String, year: Int, cast: String, director: String, genres: [Country], countries: [Country], voice: String?, duration: Duration, langs: Int, quality: Int, plot: String, tracklist: AnyCodable, imdb: Int?, imdbRating: Double?, imdbVotes: Int?, kinopoisk: Int?, kinopoiskRating: Double?, kinopoiskVotes: Int?, rating: Int, ratingVotes: String, ratingPercentage: String, views: Int, comments: Int, posters: Posters, trailer: Trailer?, finished: Bool, advert: Bool, poorQuality: Bool, createdAt: Int, updatedAt: Int, inWatchlist: Bool?, subscribed: Bool?, subtitles: String) {
            self.id = id
            self.type = type
            self.subtype = subtype
            self.title = title
